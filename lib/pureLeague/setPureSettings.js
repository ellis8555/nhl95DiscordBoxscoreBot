...
const { channelsRange, coachesStartRange, coachesEndRange, bsbSheetName } = pure_consts.appendGoogleSheets.bsbSettings
...
async function setPureSettings({sheets, message}){
    ...
    try {
        ...
        let ranges = [
            ...
            `${bsbSheetName}!${coachesStartRange}:D${updateCoachesEndRange}`
        ]
