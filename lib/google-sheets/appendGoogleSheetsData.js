...
try {
    ...
    } = await assembleRawData({sheets, spreadsheetId, range, tempCSVData})
    ...
    range: `RawPlayer!F${rawPlayerNextFreeRowNumber}:U${rawPlayerNextFreeRowNumber + rawPlayerData.length-1}`,
    resource: {
