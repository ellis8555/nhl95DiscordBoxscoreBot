...
async function displayRemainingOpponents(seasonGamesChannelId, {server, client, teamAbbreviation, teamCodes, coaches, uniqueIdsFile}){
    ...
    if(teamCodes.length > 0){
        ...
        const fullSeriesGamesRemainingTotal = teamCodes.length * 4;
        ...
        const remainingOpponentsImage = await generateRemainingOpponentsImage({server, teamCodes, sortedGamesPlayed})
        ...
        await channel.send(`${teamAbbreviation} season is complete.`)
    }
