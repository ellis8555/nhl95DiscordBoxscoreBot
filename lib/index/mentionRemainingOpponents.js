async function mentionRemainingOpponents(seasonGamesChannelId, {server, client, coachId, teamCodes, userMessage, coaches, uniqueIdsFile}){
    ...
    if(teamCodes.length > 0){
        ...
        seasonGamesCall += `\n<:${coachObject.team}:${coachObject.emojiId}>`
